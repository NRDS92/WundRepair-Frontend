...
export default function Cart({ setOpenCart, children }) {
  ...
  return createPortal(
    <div className=' fixed inset-0   flex items-center justify-center '>
        {cartDisplay === "product" ? 
            <div className='w-[95%] md:w-[55%] h-[660px] md:h-[800px] backdrop-blur-md mt-10 shadow-xl relative p-8 md:p-10 rounded-[50px] border-4  border-white'>
                ...
                <div className=' flex md:flex-row flex-col items-center justify-evenly mt-5 md:mt-10 '>
