...
export default function Checkout({setOpenCart, totalItems, subTotal, totalPrice}) {
        const deliveryFee = 5;
  return (
    <div className='w-[95%] md:w-[55%] h-[700px] md:h-[800px] backdrop-blur-md shadow-xl relative p-8 md:p-10 rounded-[50px] border-4  border-white '>
    ...
    <div className=' flex md:flex-row flex-col items-center justify-evenly  mt-8 md:mt-10 '>
        <h2 className='md:text-5xl text-3xl font-bold mb-3 md:mb-5 merriweather'>Checkout</h2>
    </div>
